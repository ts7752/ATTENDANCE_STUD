...
public class StudentList extends AppCompatActivity {
    ...
    protected static final String TAG = "StudentList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView2 = findViewById(R.id.tv_StdList);
